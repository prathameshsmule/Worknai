        ...
        <div className={styles.newSectionContent}>
          ...
          <div className={styles.newLeftContent}>
            ...
            <p className={styles.newDescription}>
              Kickstart your career in web development with our Java Full Stack Developer Course, designed to equip you with the skills to build robust, end-to-end applications using Core Java, Spring Boot, Hibernate, Angular/React, and MySQL. This hands-on program covers both frontend and backend development, enabling you to create dynamic user interfaces, develop and integrate RESTful APIs, manage databases efficiently, and deploy secure, scalable applications. Ideal for students, freshers, and professionals aiming to become industry-ready full stack developers.
            </p>
        ...
        <div className={styles.learnContent}>
          ...
          <div className={styles.learnRight}>
            ...
            <p className={styles.learnSubtitle}>
             Build Robust and Enterprise-Grade Full-
             Stack Applications with the Java Stack
            </p>
            ...
            <div className={styles.skillsGrid}>
              <div className={styles.skillsColumn}>
                ...
                <div className={styles.skillItem}>
                  <span className={styles.checkIcon}>✓</span>
                  <p className={styles.skillText}>
                   Apply object-oriented programming (OOP) principles with Core Java
                  </p>
                </div>
              ...
              <div className={styles.skillsColumn}>
                ...
                <div className={styles.skillItem}>
                  <span className={styles.checkIcon}>✓</span>
                  <p className={styles.skillText}>
                    Implement dependency injection, data binding, and MVC architecture
                  </p>
                </div>
                ...
                <div className={styles.skillItem}>
                  <span className={styles.checkIcon}>✓</span>
                  <p className={styles.skillText}>
                    Deploy Java full-stack applications on cloud platforms
                  </p>
                </div>
                ...
                <div className={styles.skillItem}>
                  <span className={styles.checkIcon}>✓</span>
                  <p className={styles.skillText}>
                   Build real-world projects following enterprise development practices
                  </p>
                </div>
              </div>
            </div>
