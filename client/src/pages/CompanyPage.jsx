    ...
    <div className={styles.companyPage}>
      ...
      <section className={styles.approachSection}>
        ...
        <div className={styles.approachContent}>
          ...
          <p className={styles.approachDescription}>
            At Newgen Softech, we craft cutting-edge web,
            mobile, and software solutions to accelerate business
            growth. Stay ahead with our expertise in custom
            development, cloud solutions, and emerging
            technologies! 🚀
          </p>
        </div>
      </section>
        ...
        <div className={styles.servicesContainer}>
          <div className={styles.servicesIllustration}>
            <svg viewBox="0 0 500 400" className={styles.devIllustration}>
              {/* Monitor */}
              <rect x="80" y="60" width="340" height="220" rx="8" fill="#3D4A5C" />
              <rect x="95" y="75" width="310" height="185" rx="4" fill="#F8F9FA" />
              
              {/* Code Lines */}
              <rect x="120" y="100" width="80" height="8" rx="4" fill="#60A5FA" />
              <rect x="210" y="100" width="120" height="8" rx="4" fill="#E0E7FF" />
              <rect x="120" y="125" width="60" height="8" rx="4" fill="#FBBF24" />
              <rect x="190" y="125" width="140" height="8" rx="4" fill="#E0E7FF" />
              <rect x="120" y="150" width="100" height="8" rx="4" fill="#34D399" />
              <rect x="230" y="150" width="100" height="8" rx="4" fill="#E0E7FF" />
              
              {/* Color Boxes */}
              <rect x="360" y="100" width="30" height="30" rx="4" fill="#60A5FA" />
              <rect x="360" y="140" width="30" height="30" rx="4" fill="#FBBF24" />
              <rect x="360" y="180" width="30" height="30" rx="4" fill="#34D399" />
              <rect x="360" y="220" width="30" height="30" rx="4" fill="#F87171" />
              ...
              {/* Keyboard */}
              <rect x="150" y="310" width="200" height="70" rx="6" fill="#3D4A5C" />
              ...
              {/* Code Symbol */}
              <rect x="100" y="320" width="40" height="50" rx="6" fill="#8B5CF6" />
              <text x="120" y="352" fontSize="24" fill="white" textAnchor="middle" fontFamily="monospace">{"{ }"}</text>
            </svg>
          </div>
          ...
          <div className={styles.servicesContent}>
            ...
            <p className={styles.servicesDescription}>
              In today's digital age, a well-crafted website is not just an online
              presence—it's a powerful tool for business growth, brand visibility, and
              customer engagement.
            </p>
            <p className={styles.servicesDescription}>
              With over 18 years of experience and 1,000+ successful web projects,
              we specialize in creating high-performance websites and tailored
              software solutions. Our expertise in web development ensures that
              businesses leverage cutting-edge technology for increased
      ...
      <section className={styles.coreAppSection}>
        <div className={styles.coreAppContainer}>
          ...
          <div className={styles.coreAppDescription}>
            <p>
              At Newgen Softtech, we are a globally recognized team of software
              engineers, delivering custom software solutions that drive innovation and
              business success. Since 1997, we have developed numerous enterprise
              applications, CMS platforms, process automation tools, and databases—
              adapting to the latest technologies to offer scalable and future-ready
              solutions. We prioritize customized software engineering that aligns with
              your business goals, industry trends, and evolving technology to ensure a
              competitive edge.
            </p>
          </div>

          <button className={styles.coreAppContactBtn}>
            Contact Us →
          </button>
        </div>
      </section>
      ...
      <section className={styles.mobileAppSection}>
        <div className={styles.mobileAppContainer}>
          ...
          <div className={styles.mobileAppContent}>
            <h2 className={styles.mobileAppTitle}>Mobile Application Development</h2>
            ...
            <p className={styles.mobileAppDescription}>
              ...
              a seamless digital experience for your customers. Whether it's Android 
              or iOS, we develop apps that increase customer engagement and boost 
              your ROI.
            </p>
          </div>
        </div>
        ...
        <div className={styles.technologiesGrid}>
          <div className={styles.techCard}>
            ...
            <p className={styles.techCardText}>
              .NET, ASP.NET, VB.NET, JAVA, JSP, J2EE, PHP, C, C++, C#, PL/SQL, XML
            </p>
          </div>
      ...
      <section className={styles.studentsSection}>
        <h2 className={styles.studentsTitle}>
          Our Students are <span className={styles.workingText}>Working</span> at
        </h2>
